...
Система призначена для моніторингу сигналів одного телеграм-каналу, в який надсилаються сигнали з інших каналів (3-6) та автоматичного виконання торгових операцій на криптовалютній біржі BingX відповідно до цих сигналів.
...
```
{
  "global_settings": {
    ...
    // Інші глобальні параметри...
  },
  "channels": {
    "channel_1": {
      "name": "VIP марафон | Даниэль",
      "entry_percentage": 5,
      "tp_distribution": [30, 50, 20] // TP1, TP2, TP3
    },
    "channel_2": {
    ...
    "channel_3": {
      ...
      "entry_percentage": 4,
      "tp_distribution": [70, 30], // TP1, TP2
      "max_open_positions": 3 // Приклад
    },
    "channel_4": {
      "name": "KostyaKogan",
      "entry_percentage": 5,
  ...
  "notifications": {
      "telegram_bot_token": "YOUR_BOT_TOKEN", // Якщо потрібні сповіщення
      "telegram_chat_id": "YOUR_CHAT_ID"    // Якщо потрібні сповіщення
  }
  // ... інші секції, якщо потрібно ...
}
```
